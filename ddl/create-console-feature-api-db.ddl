...
create table ENV_FEATURE_ENV_MICROSERVICE (ENV_FEATURE_ID int8 not null, ENV_MICROSERVICE_ID int8 not null, primary key (ENV_FEATURE_ID, ENV_MICROSERVICE_ID));
...
alter table ENV_FEATURE_ENV_MICROSERVICE add constraint FKnqj46cu1i26puc6gtd8sn74bc foreign key (ENV_MICROSERVICE_ID) references ENV_MICROSERVICE;
alter table ENV_FEATURE_ENV_MICROSERVICE add constraint FKrboektlfioex0s08u4ps2fu9l foreign key (ENV_FEATURE_ID) references ENV_FEATURE;
