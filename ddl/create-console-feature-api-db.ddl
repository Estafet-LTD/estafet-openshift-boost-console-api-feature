...
create table ENV (ENV_ID varchar(255) not null, LIVE boolean not null, NEXT varchar(255), TESTED boolean, UPDATED_DATE varchar(255) not null, primary key (ENV_ID));
