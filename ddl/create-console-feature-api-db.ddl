...
create table REPO_COMMIT (MATCHED_TYPE varchar(31) not null, REPO_COMMIT_ID int8 not null, SHA varchar(255) not null, VERSION varchar(255) not null, REPO_ID varchar(255) not null, FEATURE_ID varchar(255) not null, primary key (REPO_COMMIT_ID));
